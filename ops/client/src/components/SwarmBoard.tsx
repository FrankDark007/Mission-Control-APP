    ...
    return (
        <div className="space-y-6 md:space-y-8 lg:space-y-10 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-white tracking-tighter mb-1">Mission Board</h2>
                    <p className="text-xs md:text-sm text-gray-500 font-medium">Orchestrate multi-agent workflows and autonomous worktrees.</p>
                </div>
                <div className="flex gap-4">
                    <button
                        onClick={() => setIsAdding(!isAdding)}
                        className="bg-google-blue text-white px-4 md:px-6 lg:px-8 py-2.5 md:py-3 rounded-xl md:rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-widest shadow-xl flex items-center gap-2 md:gap-3 transition-all hover:scale-105"
                    >
                        <Plus size={16} className="md:w-[18px] md:h-[18px]" /> Initiate Mission
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-1 space-y-4 md:space-y-6">
                    <div className="bg-dark-800 p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-[2rem] lg:rounded-[2.5rem] border border-dark-700 shadow-2xl space-y-4 md:space-y-6">
                ...
                {/* Mission Columns */}
                <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                    {/* Column: Queue */}
